<template>
   <div class="restraunts__item">
        <div class="restraunts__item-img">
          <img src="https://pandabanda.city/upload/resize_cache/iblock/6f7/520_400_2/6f767d127086035aa484528db420919a.jpg?1592075031119921" alt="img-1">
        </div>
        <div class="restraunts__item-about">
        <h3 class="restraunts__item-title">
          Пицца плюс
        </h3>
       <p class="restraunts__item-time">50 мин</p>
      </div>
        <div class="restraunts__item-flex">
          <div class="restraunts__item-stars">
          ...
          <span class="restraunts__item-price">От 900 Р</span>
          <span class="restraunts__item-category">Пицца</span>
        </div>
      </div>
</template>
